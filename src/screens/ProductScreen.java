...
public class ProductScreen extends CarouselScreen {
    ...
    final int section;  // Número de la sección seleccionada para mostrar los productos de esa sección.
    ...
    public KioskScreen show(Context context) {
        ...
        while (option == 'D'){
            ...
            numberProducts++;
            context.getKiosk().setDescription(context.getMenuCard().getSection(section).getProduct(index).getDescription() + "\n" + numberProducts + "Unidades");
            option = context.getKiosk().waitEvent(30);
        }
    ...
    private void configureButtons(Context context) {
        ...
        context.getKiosk().setOption('D', "+1");
