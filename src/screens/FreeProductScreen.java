 ...
 * @author ramon
 */
public class FreeProductScreen extends ProductScreen {

    public FreeProductScreen(int section) {
        super(section);
    }
    /**
...
// Espera la respuesta del usuario (evento de los botones)
        ...
        return new WelcomeScreen();  // Determina la siguiente pantalla según la opción seleccionada por el usuario
    }
